...
object AnyCodecs {
  ...
  class AnyCodec[K, V](val compatibilityMode: Boolean)
    ...
    implicit def keyCodec: Codec[K] = kCodec
    implicit def valCodec: Codec[V] = vCodec
  }
  ...
  object DefaultAnyCodec extends AnyCodecBase[Any, Any] {
    ...
    implicit def keyCodec: DefaultAnyCodec.type = this
    implicit def valCodec: DefaultAnyCodec.type = this
  }

  object DefaultAnyCodecCompat extends AnyCodecBase[Any, Any] {
    def compatibilityMode = true
    implicit def keyCodec : DefaultAnyCodecCompat.type = this
    implicit def valCodec : DefaultAnyCodecCompat.type = this
  }
}