...
abstract class ComponentTrial(doc: String)(implicit loc: SourceLocation)
  ...
  val Options = List(
    ...
    OPT("-A", nonalt, false, s"Use alt-capable transport for Commstime"),
...
/** A light test of shared transport. Runs writers in parallel with readers
...
/** A test of shared transport. Runs writers in parallel with readers:
...
/** This is a tad slower than commscso because the transport are referenced as
  * free variables.
  *
